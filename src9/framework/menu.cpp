...
extern const Menu menu_main, menu_armv5, menu_ipc, menu_dsmath, menu_memory, menu_initialstate;
...
const Menu menu_main = {menu_main_entries, "ROCKWRESTLER v0.1", nullptr};
...
// if I define them as a global var in this file, some weird stuff happens where the section they're
// in is displaced by 64 KB, while reading from the variable does not take into account this offset
// -> it doesn't work. if you can fix this, please do. these symbols are defined in menu.s
extern const Menu* menu_selected;
extern int menu_index;

extern "C" void cpp_menu()
{
    // first time running this function: go to main menu
