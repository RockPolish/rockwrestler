...
arm-none-eabi-ld arm9.o -Ttext 0x2000100
arm-none-eabi-objcopy -O binary a.out arm9.bin --image-base=0x2000100
arm-none-eabi-objdump a.out -D -M reg-names-raw > 9.txt
...
arm-none-eabi-ld arm7.o -Ttext 0x3800100
arm-none-eabi-objcopy -O binary a.out arm7.bin --image-base=0x3800100
arm-none-eabi-objdump a.out -D -M reg-names-raw > 7.txt

ndstool -c rockwrestler.nds -r9 0x2000100 -e9 0x2000100 -r7 0x3800100 -e7 0x3800100 -9 arm9.bin -7 arm7.bin # -d data/

# remove files
rm a.out arm7.bin arm9.bin arm7.o arm9.o
